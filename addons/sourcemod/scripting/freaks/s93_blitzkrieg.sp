...
public OnPluginStart2()
{
	...
	PrintToServer("------------BETA 1.77 EXPERIMENTAL - BY SHADoW NiNE TR3S----------------");
	PrintToServer("------------------------------------------------------------------------");
